...
// /* ########################################################################## */
// /**
//  * TODO:* Create a function named `analyzeColor` that accepts a string that is a color
...
function analyzeColor(randomColor){
    switch(randomColor){
        ...
        case "blue":
            return "Your color is " +randomColor+ " !";
        default:
            return "Your " +randomColor+ " is cool, but I am not a fan!";
    }
}
//     console.log(analyzeColor(randomColor));
//
...
//  */
//
let colorEntered = prompt("Please enter a color!").toLowerCase().trim();
    alert(analyzeColor(colorEntered));
